            ...
            <div class="card p-4">
                ...
                <form action="del" method="get">
                    ...
                    <div class="mt-4">
                        ...
                        <button class="btn btn-danger btn-lg" type="button" onclick="window.location.href='/rrrhh-web/asistencia/findAll'; return false;">Cancelar <i class="fa-solid fa-x"></i></button>
                    </div>
                </form>
            </div>
        </div>
